...
class LinearOCP:
    ...
    def build_dae_integrator(self):
        """
        Creates integrator for differential algebraic equations
        """

        print(self.z.shape)
        print(self.u.shape)
        print(self.d.shape)
        print(self.alg.shape)
        dae = {
            "x": self.x,
            "z": self.z,
            "p": self.u,
        ...
        return integrator("I", "idas", dae, opts)
    ...
    def build_nlp(self):
        ...
        for k in range(self.N):
            ...
            w += [Uk]
            lbw += [-self.Pb_max, -self.Pb_max, -self.Pg_max]
    ...
    def solve_nlp(self, params, p_ref):
        ...
        x_opt = [w_opt[5::n], w_opt[6::n]]
        u_opt = [w_opt[2::n], w_opt[3::n], w_opt[4::n]]
        t_opt = [w_opt[7::n], w_opt[8::n], w_opt[9::n]]
